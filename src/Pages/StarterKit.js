...
const StarterKit = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Digital Starter Kit for Australia - Complete Pre & Post Arrival Guide
          | Kothar Education
        </title>
        <meta
          name="description"
          content="Complete Digital Starter Kit for international students moving to Australia. Pre-arrival checklist, post-arrival essentials, visa guidance, accommodation tips, banking, TFN, transport, and health services. Expert guidance from Kothar Education Services."
        />
        <meta
          name="keywords"
          content="Australia student visa, international students Australia, pre-arrival checklist, post-arrival guide, Australian power adapter, declaration form, TFN application, Australian bank account, student accommodation Australia, OSHC health cover, public transport Australia"
        />
        ...
        <meta property="og:url" content="https://kotharedu.com/starter-kit" />
        <meta
          property="og:title"
          content="Digital Starter Kit for Australia - Complete Pre & Post Arrival Guide"
        />
        <meta
          property="og:description"
          content="Essential guide for international students moving to Australia. Pre-arrival checklist, post-arrival essentials, visa guidance, and expert support from Kothar Education Services."
        />
        <meta
          property="og:image"
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://kotharedu.com/starter-kit" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "HowTo",
            name: "Digital Starter Kit for International Students Moving to Australia",
            description:
              "Complete guide for pre-arrival and post-arrival essentials for international students moving to Australia",
            ...
            publisher: {
              ...
              logo: {
                "@type": "ImageObject",
                url: "https://kotharedu.com/kothar_logo.png",
              },
            },
            step: [
              {
                ...
                text: "Book flights, pack essentials, prepare funds, and understand declaration requirements",
              },
              {
                "@type": "HowToStep",
                name: "Post-Arrival Essentials",
                text: "Get SIM card, open bank account, apply for TFN, understand public transport, and health services",
              },
            ],
          })}
        </script>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-second via-orange-400 to-orange-500 rounded-3xl shadow-2xl p-12 mb-16 text-white transform transition-all duration-1000">
              ...
              <p className="md:text-2xl text-lg mb-8">
                ...
                steps before and after your arrival, ensuring a smooth
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-8 mb-8 transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <strong>When to Book:</strong> Book well in advance
                        after receiving your visa grant for better deals
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                      <div>
                        <strong>Airlines:</strong> Research different airlines
                        for student discounts and flexible booking options
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                    ...
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                      <div>
                        <strong>Travel Insurance:</strong> Purchase
                        comprehensive travel insurance covering flight, luggage,
                        and health
                      </div>
                    </div>
                  </div>
              ...
              <div className="mb-12">
                <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-8 mb-8 transform hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-gray-700 mb-6">
                    Australia has strict customs regulations. Here's what you
                  ...
                  <div className="space-y-4 text-gray-700">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        A$10,000 or more, you must declare at customs, but
                ...
                <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-8 mb-8 transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                      <div>
                        <strong>Major Banks:</strong> Commonwealth Bank,
                        Westpac, NAB, ANZ
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl p-8 mb-8 transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="space-y-4 text-gray-700">
                    ...
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                      <div>
                        <strong>When to Apply:</strong> After arrival in
                        Australia with a valid work visa
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                      <div>
                        <strong>Information Needed:</strong> Passport details
                ...
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 mb-8 transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex items-start gap-3">
                      <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                      <div>
                        <strong>Smart Cards:</strong> Opal Card (NSW), Myki
                        (VIC), Go Card (QLD)
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
              ...
              <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-2xl p-8 transform hover:scale-105 transition-all duration-300">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
                    <div>
                      <strong>University Support:</strong> Your university
                      offers academic, welfare, and health services.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <FaCheckCircle className="text-green-500 text-xl mt-1 flex-shrink-0" />
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-3xl p-10 mb-16 transform hover:scale-105 transition-all duration-300">
              ...
              <div className="text-center space-y-6">
                <p className="text-xl text-gray-700">
                  ...
                  journey to Australia! Should you have any questions, remember
                  to consult us.
                </p>
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                  <p className="text-yellow-800 font-bold text-lg">
                    💪 Keep patience and keep working hard, as the journey will
                    be full of roller coasters in Australia. Keep your head
                    high, cheers mate! 🍻
                  </p>
                </div>
              </div>
